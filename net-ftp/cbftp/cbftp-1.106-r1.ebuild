...
DESCRIPTION="Cbftp is an advanced multi-purpose FTP/FXP client that focuses on efficient
...
HOMEPAGE="http://github.com/cbftp/cbftp"

# Point to any required sources; these will be automatically downloaded by
# Portage.
SRC_URI="https://github.com/cbftp/cbftp/releases/download/1106/cbftp-r1106.tar.gz"

# Source directory; the dir where the sources can be found (automatically
# unpacked) inside ${WORKDIR}.  The default value for S is ${WORKDIR}/${P}
# If you don't need to change it, leave the S= line out of the ebuild
# to keep it tidy.
S="${WORKDIR}/cbftp-r1106"
...
#sed 's/${WORKDIR}/cbftp-r1106/Makefile.in'
sed -i -E -e 's/-lncurses(w)?/& -ltinfo\1/g' /var/tmp/notmpfs/portage/net-ftp/cbftp-1.106-r1/work/cbftp-r1106/Makefile.inc
#echo "$(DESTDIR)="/usr/local/bin"" >> /var/tmp/notmpfs/portage/net-ftp/cbftp-1.106-r1/work/cbftp-r1106/Makefile.inc
        #econf
	#
...
#dobin cbftp cbftp-debug datafilecat datafilewrite;
dobin bin/*;
#emake install
